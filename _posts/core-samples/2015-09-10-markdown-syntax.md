...
markdown syntax
	...
	[link text](http://mrandrewandrade.com/blog/)
...
Jekyll is using `kramdown` as the markdown flavour, which is outlined on the offical [page](http://kramdown.gettalong.org/syntax.html)
